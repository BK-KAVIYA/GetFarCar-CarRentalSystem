...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 28, 2022 at 09:04 AM
...
INSERT INTO `admin` (`A_ID`, `Fname`, `Lname`, `Telephone`, `Line1`, `Line2`, `Line3`) VALUES
('Ad001', 'Baladurage', 'Kavinda', 716548989, 'Dadallage waththa', 'Thalalla road', 'Kekanadura'),
('Ad002', 'Pawara', 'Pramuditha', 713703263, 'Pustolamulla', 'Ranakeliya', 'Tissamaharama');
...
INSERT INTO `car` (`Car_ID`, `Cname`, `Car_type`, `Status`, `Price`, `No_of_seat`) VALUES
('C0001', 'Car001', 'Wagan R', 'T', 4500, 4),
('C0002', 'Car002', 'Alto LXI', 'T', 4000, 4);
...
INSERT INTO `checkout` (`Check_ID`, `Amount`, `Date`, `Cus_ID`, `Admin_ID`) VALUES
('No001', 4500, '2022-10-24', 'Cus001', 'Ad001'),
('No002', 9000, '2022-10-23', 'Cus002', 'Ad001');
...
INSERT INTO `maintance` (`M_ID`, `Reason`, `Parts`, `Cost`, `Car_ID`) VALUES
('M0001', 'Engine Repair', 'Piston', 8500, 'C0001'),
('M0002', 'Patch', 'Tire', 4520, 'C0001');
